...
class ArmFrame(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.eMagnetSwitch = QPushButton("off")
        self.eMagnetSwitch.setMinimumWidth(50)

        # layout
        self.layout = QGridLayout()
        self.layout.addWidget(self.label, 0, 0, 1, 3, Qt.AlignHCenter)
        self.layout.addWidget(self.hLine, 1, 0, 1, 3)
        self.layout.addWidget(self.baseLabel, 2, 0)
        self.layout.addWidget(self.ccwButton, 3, 0)
        self.layout.addWidget(self.cwButton, 3, 2)
        self.layout.addWidget(self.basePowerLabel, 4, 0)
        self.layout.addWidget(self.basePowerInput, 4, 1)
        self.layout.addWidget(self.basePowerSet, 4, 2)
        self.layout.addWidget(self.linActuatorLabel, 5, 0)
        self.layout.addWidget(self.upButton, 6, 0, 1, 3, Qt.AlignHCenter)
        self.layout.addWidget(self.downButton, 7, 0, 1, 3, Qt.AlignHCenter)
        self.layout.addWidget(self.linActPowerLabel, 8, 0)
        self.layout.addWidget(self.linActPowerInput, 8, 1)
        self.layout.addWidget(self.linActPowerSet, 8, 2)
        self.layout.addWidget(self.eMagnetLabel, 9, 0)
