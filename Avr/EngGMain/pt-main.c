static int pt_main(struct pt *pt) {
	...
	nav_base(10, 0); // TODO: put TARGET HEADING instead
	nav_actu(2, 300); PT_WAIT_UNTIL(pt, ref_complete[MOTOR4]); // TODO: lower height
    ...
    // aim for target
	nav_base(10, -82); // TARGET HEADING. TODO: put above
	PT_WAIT_UNTIL(pt, drive_complete && pid_complete[MOTOR3] && pid_complete[MOTOR4]);
	SLEEP(400); // shoot once stabilized
    // shoot. Try twice in case stuck. TODO: multi-cycle quickly for like 5 times
    ...
    // rotate the base and actu at the same time. TODO: put before driving
	...
	nav_stop(); // TODO: remove unneeded nav_stops
